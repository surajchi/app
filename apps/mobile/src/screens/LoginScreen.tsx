  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 justify-center px-6">
        <Text className="mb-1 text-3xl font-bold text-slate-900">FinPulse</Text>
        <Text className="mb-8 text-base text-slate-500">Sign in to your account</Text>
        ...
        <Button title="Log in" loading={mutation.isPending} onPress={handleSubmit(onSubmit)} />

        <View className="mt-4 flex-row justify-center">
          <Text className="text-slate-500">No account? </Text>
          <Text
